...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    textSize(30);
    text('Pressione a tecla para cima para reiniciar', 350, 200)
    ...
    //escreva uma condição para chamar a função reset()i
    if(keyDown('UP_ARROW')){
      reset();
    }
    }
...
function reset(){
  ...
  gameOver.visible = false;
  distance = 0;
  mainCyclist.changeAnimation('animation', mainRacerImg1);
  pinkCG.destroyEach();
